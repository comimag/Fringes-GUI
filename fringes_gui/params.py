    ...
    vid = {
        ...
        "children": [
            ...
            },
            {
                ...
                "limits": (
                    1,
                    min(gui.fringes._Ymax, gui.fringes._Pmax / gui.fringes.X),
                ),
                "step": 10,
                "suffix": " px",
            ...
            },
            {
                ...
                "limits": (
                    1,
                    min(gui.fringes._Xmax, gui.fringes._Pmax / gui.fringes.Y),
                ),
                "step": 10,
                "suffix": " px",
                ...
                "children": [
                    {
                        ...
                        "name": "indexing",
                        "type": "list",
                        "value": gui.fringes.indexing,
                        "default": gui.fringes.defaults["indexing"],
                        "limits": gui.fringes._indexings,
                        "tip": gui.fringes.__class__.indexing.__doc__,
                    },
                    {
                        "title": "Axis",
                        "name": "axis",
                        "type": "list",
                        "value": gui.fringes.axis,
                        "default": gui.fringes.defaults["axis"],
                        "limits": (0, 1),
    ...
    val = {
        ...
        "children": [
            ...
            },
            {
                ...
                "limits": (
                    gui.fringes.B,
                    min(gui.fringes.A, gui.fringes.Imax - gui.fringes.A),
                ),
                "decimals": gui.digits,
